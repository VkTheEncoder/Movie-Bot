...
BOT_TOKEN = environ.get('BOT_TOKEN', "7628116782:AAHO523kFNdBl0xk11Md3qAx3O6QLikD7e8")
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1423807625').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002352737026'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002025087044').split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://dodopi2476:JPdXXhzk6BwPBdZS@cluster0.t9o1hts.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "VK")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'VKcollection')
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/all_movies_request_public')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/all_movies_request_public')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/all_movies_request_public') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/THe_vK_3')
