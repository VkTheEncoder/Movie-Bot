...
API_ID = int(environ.get('API_ID', '27294940'))
API_HASH = environ.get('API_HASH', '67dea18182fcb410bd8c4e1a336d8c9e')
BOT_TOKEN = environ.get('BOT_TOKEN', "7607845966:AAH1Zwrd2vIm2lipzFV_ygy7BtNSrTRjDaw")


# This Pictures Is For Start Message Picture, You Can Add Multiple By Giving One Space Between Each.
PICS = (environ.get('PICS', 'https://ibb.co/3mkVFmmQ')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5478765030, 7038050465').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002505082306'))
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002276280920, -1002039617609') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None

# This Channel Is For When User Request Any File Name With command or hashtag like - /request or #request
reqst_channel = environ.get('REQST_CHANNEL', '1001805846204')
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001386750213')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://poisondeath1921:N8pGonrmdVx1mzBB@cluster0.3bdouge.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
